...
Faastion combines Native Image Isolates, leveraging Language Based Isolation (LBI) during managed code execution; and Memory Protection Keys (MPK) during native code execution.
