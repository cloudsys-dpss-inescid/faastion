...
import static org.graalvm.argo.faastion.utils.JsonUtils.json;
...
import org.graalvm.argo.faastion.function.TruffleFunction;
 ...
 * code in HotSpot but it can be extended by running Faastion runtimes
 * through JNI.
 *
...
public class HotSpotProxy extends RuntimeProxy {
    ...
    static {
        ...
        try {
            ...
            System.out.println("Warning: faastion compiled with no truffle language support.");
        } finally {
