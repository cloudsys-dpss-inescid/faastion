...
public class NativeSandboxInterfaceFeature implements Feature {
    ...
    public void beforeAnalysis(BeforeAnalysisAccess access) {
        ...
        // Treat JNI calls in "org.graalvm.argo.faastion.sandboxing.NativeSandboxInterface" as calls to built-in library.
        PlatformNativeLibrarySupport.singleton().addBuiltinPkgNativePrefix("org_graalvm_argo_faastion_sandboxing_NativeSandboxInterface");
