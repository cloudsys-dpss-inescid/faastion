...
hidden int __pthread_sandbox_init(void);
hidden int __pthread_sandbox_enter(int);
hidden int __pthread_sandbox_leave(int);
hidden int __pthread_sandbox_call(int, void**, void *(*)(void *), void *restrict);
