...
function build_jni_libraries {
        ...
        gcc $CFLAGS -o $LIB_DIR/libhelloworld.so $SRC_DIR/HelloWorld.c -lm
}
...
function run_jni {
        ...
        java -cp $CLS_DIR -Djava.library.path=$LIB_DIR HelloWorld
...
export class_path=$(DIR)/build/libs/helloworld-all.jar
export entrypoint="HelloWorld"
