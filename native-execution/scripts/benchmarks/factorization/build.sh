...
function build_jni_libraries {
        ...
        gcc $CFLAGS -o $LIB_DIR/libfactorization.so $SRC_DIR/Factorization.c -lm
}
...
function run_jni {
        ...
        java -cp $CLS_DIR -Djava.library.path=$LIB_DIR Factorization
...
export class_path=$(DIR)/build/libs/factorization-all.jar
export entrypoint="Factorization"
