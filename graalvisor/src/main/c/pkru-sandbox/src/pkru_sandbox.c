...
// TODO: future dlopens per tid should not create new namespaces (aka lmid)
// void *dlopen(const char *input, int flag)
// {
//     // distinguish between jvm and user calls
//     fprintf(stderr, "custom dlopen\n");
//     pid_t tid = gettid();
//     ThreadInfo *info = insert_thread_info(tid, input);
//     void *handle = dlmopen(LM_ID_NEWLM, input, flag | RTLD_GLOBAL);
//     info->register_mmaps = 0;
//     return handle;
// }
